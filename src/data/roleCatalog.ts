...
export const ROLE_CATALOG: RoleDefinition[] = [
  ...
  { id: 'anarchist', name: 'Wild Card', alignment: 'Independent', summary: 'Tries to bait the table into ejecting them first for a solo win. If another player is ejected first, Staying Power activates: pivots into a Rogue Citizen to hunt Imposters.', knows: 'The true secret word.', power: 'Draw Round 1 suspicion for a solo win. If another player is ejected first, activate Staying Power as a Rogue Citizen using your true word knowledge.', wins: 'Solo Heist: Ejected on the very first vote. | Staying Power: If another player is ejected first, win with Citizens by catching all Imposters.', recommended: '9 or more players', complexity: 'Advanced', image: portrait('wild-card') }
];
